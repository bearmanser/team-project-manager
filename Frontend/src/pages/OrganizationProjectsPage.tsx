...
import type { ProjectSummary, Repo, User } from "../types";
...
type OrganizationProjectsPageProps = {
    ...
    onCreateProjectFormChange: (field: "name" | "description" | "repositoryId", value: string) => void;
                ...
                <Grid templateColumns={{ base: "1fr", xl: "1.1fr 0.9fr" }} gap="8">
                    <Stack gap="4">
                        ...
                        <Text color="#b0bccf" maxW="2xl">
                            Teams belong to the organization, while each project stays tied to exactly one GitHub
                            repository.
                        </Text>
                    </Stack>
                    <SurfaceCard p="5" bg="#0f141b">
                        <Stack gap="3">
                            ...
                            <Text color="#d8e1ee">{currentUser.email}</Text>
                            <StatusPill label={isGitHubConnected ? "GitHub linked" : "GitHub not linked"} />
                        </Stack>
                    </SurfaceCard>
                </Grid>
            </SurfaceCard>
                    ...
                    {showCreateForm ? (
                        !isGitHubConnected ? (
                            <SurfaceCard p="5" bg="#0f141b">
                                <Stack gap="4">
                                    <Text color="#d8e1ee">
                                        Connect GitHub first. A project now maps to a single repository from day one.
                                    </Text>
                            ...
                            >
                                ...
                                <Stack gap="2">
                                    ...
                                    <select
                                        ...
                                        onChange={(event) =>
                                            onCreateProjectFormChange("repositoryId", event.target.value)
                                        }
                                    >
                                ...
                                <Stack gap="2" gridColumn={{ base: "auto", xl: "1 / span 2" }}>
                                    ...
                                    <Textarea
                                        ...
                                        onChange={(event) =>
                                            onCreateProjectFormChange("description", event.target.value)
                                        }
                                        bg="#0f141b"
                                        borderColor="#2b3544"
                                        borderRadius="0"
            ...
            <Grid templateColumns={{ base: "1fr", xl: "repeat(2, 1fr)" }} gap="4">
                {projects.length ? (
                            ...
                            <Stack gap="4">
                                ...
                                <Grid templateColumns="repeat(3, 1fr)" gap="3">
                                    <SurfaceCard p="3" bg="#111720">
                                        <Text color="#90a0b7" fontSize="xs" textTransform="uppercase">
                                            Repo
                                        </Text>
                                ...
                                <Button borderRadius="0" bg="#2d6cdf" color="#f8fbff" onClick={() => onOpenProject(project.id)}>
                                    Open project
                                </Button>
                            </Stack>
                        </SurfaceCard>
                    ...
                    <SurfaceCard p="6" bg="#0f141b">
                        <Text color="#90a0b7">No projects yet. Create the first project to start planning work.</Text>
                    </SurfaceCard>
                )}
            </Grid>
        </Stack>
